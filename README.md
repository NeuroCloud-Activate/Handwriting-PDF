...
Install the plugin in your vault, open the Handwriting PDF settings, and add your Gemini API key. The default model is `gemini-3.1-flash-lite`, and you can change it if you want to use another Gemini model that supports PDF input.
...
- Linked PDF: [[example.pdf]]
- OCR model: `gemini-3.1-flash-lite`
- Created: 2026-06-07T09:30:00-04:00
